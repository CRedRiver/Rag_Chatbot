...
class BuildChromaDB:
    ...
    def build_(self, file_paths: List[str], model_name="BAAI/bge-m3"):
        ...
        # Add vectors and text directly to Chroma Cloud
        if chil_docs:
            self.collection.add(
                ids=chil_ids,
